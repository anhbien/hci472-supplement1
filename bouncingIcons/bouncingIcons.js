...
lib.ssMetadata = [
		{name:"bouncingIcons_atlas_1", frames: [[0,0,862,1754]]}
];
...
(lib.chromesearch___localntp_localntphtmliPhone6_7_81 = function() {
	this.initialize(ss["bouncingIcons_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleX:1.2,scaleY:0.7143,x:399.8,y:470.35},3,cjs.Ease.quadIn).to({regX:0.2,regY:-0.1,scaleX:0.8,scaleY:1.4285,x:399.55,y:401.7},7,cjs.Ease.quartOut).to({regX:0.1,regY:0.1,scaleX:1.1428,scaleY:1,x:400.35,y:466.95},7,cjs.Ease.cubicIn).to({regX:0,regY:0,scaleX:1,x:400,y:465},2,cjs.Ease.cubicIn).wait(6));
...
// library properties:
lib.properties = {
	id: '8E1007948F0D4CBF83A960713047AEDA',
	width: 800,
	height: 600,
	fps: 24,
	color: "#CCCCCC",
	opacity: 1.00,
	manifest: [
		{src:"images/bouncingIcons_atlas_1.png", id:"bouncingIcons_atlas_1"}
	],
	preloads: []
};
...
an.compositions['8E1007948F0D4CBF83A960713047AEDA'] = {
